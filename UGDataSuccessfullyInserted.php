...
<body>
	<div class="container-fluid">
		<nav class="navbar navbar-inverse">
			...
			<div class="collapse navbar-collapse" id="Profiles" style="background-color: #04057B">
				<ul class="nav navbar-nav">
					<li><a href="ug-dashboard"> Home</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-offset-3 col-sm-6">
				<h1 class="text-center text-muted" style="color: #35AF60">Welcome To Dashboard</h1>
				<h2 class="text-center text-primary"style="color: #35AF60">Hi, <?php echo ucwords("$_SESSION[fname] $_SESSION[lname]");  ?></h2>
			</div>
		</div>
