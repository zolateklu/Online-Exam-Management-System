		...
		if(isset($_COOKIE['error']))
			...
			if(isset($_POST['submit']))
			{
				...
				if ($num == 1) 
				{
						...
						header('location:http://localhost/OES_BS/welcomesys_admin.php');
					}
					
				else
				{
					setcookie('error',"<p class='alert alert-danger text-center'>Login Id or Password May be Incorrect.</p>",time()+3);
					header('Location:sys_adminlogin.php');
				}
			}
		
		?>
	<div align="center">
			<div style = "width:250px; height: 400px; " align = "center">
				<div style = "padding:4.5px;"><h3 style="font-weight: bold;color: white;"><i> Admin Login </i></h3>
				</div>
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return AdminValidation()">
		...
		<fieldset>
					...
					<div class="input-group">
						<input type="text" name="adminid" id="adminid" placeholder="Enter Admin Id" class="form-control" required/>
					</div>
					<br>
					<div class="input-group">
					<input type="Password" name="pass" id="pass" placeholder="Enter Admin Password" class="form-control" required/>
					</div>
					<br>
					<div class="row">
						<div class="col-sm-6">
