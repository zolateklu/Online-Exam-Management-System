	...
	<div class="container">
		...
		if(isset($_COOKIE['error']))
			...
			if(isset($_POST['submit']))
			{
				...
				$query = "SELECT * FROM instructor WHERE ins_id='$id' AND password='$pass'";
		...
		?>
		 <div align="center">
			<div style = "width:250px; height: 400px; " align = "center">
				<div style = "padding:4.5px;"><h3 class="text-center" style="font-weight: bold;color: white;"> <i>Instructor Login </i></h3>
				</div>
					...
					<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return AdminValidation()">
						...
						<fieldset>
							...
							<div class="input-group">
								<input type="text" name="adminid" id="adminid" placeholder="Enter Ins. Id" class="form-control" required/>
							</div>
							<br>
							<div class="input-group">
							<input type="Password" name="pass" id="pass" placeholder="Enter Ins. Password" class="form-control" required/>
							</div>
							<br>
							<div class="row">
								<div class="col-sm-6">
